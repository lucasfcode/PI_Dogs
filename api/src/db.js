...
const { DB_USER, DB_PASSWORD = 1234, DB_HOST } = process.env;
...
const productionHost = new Sequelize({
...
Breed.belongsToMany(Temperament, { through: "BreedTemp" });
Temperament.belongsToMany(Breed, { through: "BreedTemp" });
